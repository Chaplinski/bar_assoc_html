                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li class="menu-item menu-item-has-children"><a href="#">Resources</a>
                                        <ul class="sub-menu">
                                            ...
                                            <li class="menu-item"><a href="member-list.php">Faculty Page</a></li>
                    ...
                    <div class="gdlr-core-pbf-sidebar-container gdlr-core-line-height-0 clearfix gdlr-core-js gdlr-core-container">
                            ...
                            <div class="gdlr-core-pbf-sidebar-content-inner" data-skin="Personnel">
                                <div class="gdlr-core-pbf-element">
                                    <div class="gdlr-core-personnel-item gdlr-core-item-pdb clearfix  gdlr-core-left-align gdlr-core-personnel-item-style-medium gdlr-core-personnel-style-medium">
                                        ...
                                        <iframe src="https://calendar.google.com/calendar/embed?src=scott.chaplinski%40gmail.com&ctz=America%2FChicago" style="border: 0" width="800" height="600" frameborder="0" scrolling="no"></iframe>
                                        <?php
                                        ...
                                        if(isset($_GET['law_type'])) {
                                            $statement = "SELECT `first_name`, `last_name`, `title`, `email`, `phone`, `image`, `linked_in` FROM `attorneys` WHERE `" . $_GET['law_type'] . "` = true ORDER BY `last_name` ASC";

                                        } else {
                                            $statement = "SELECT `first_name`, `last_name`, `title`, `email`, `phone`, `image`, `linked_in` FROM `attorneys` ORDER BY `last_name` ASC";
                                        }
                        ...
                        <div class="gdlr-core-pbf-sidebar-right gdlr-core-column-extend-right  kingster-sidebar-area gdlr-core-column-20 gdlr-core-pbf-sidebar-padding  gdlr-core-line-height" style="padding: 40px 0px 30px 0px;">
                            ...
                            <div class="gdlr-core-sidebar-item gdlr-core-item-pdlr">
                                ...
                                <form class="gdlr-core-course-form clearfix" action="https://demo.goodlayers.com/kingster/course-search/" method="GET">
                                        ...
                                        <div class="gdlr-core-course-search-field gdlr-core-course-field-level">
                                            <div class="gdlr-core-course-form-combobox gdlr-core-skin-e-background">
                                                <select class="gdlr-core-skin-e-content" name="level">
                                                    ...
                                                    <option value="title_and_trust">Title and Trust</option>
